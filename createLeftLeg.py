...
def createLeg(whichLeg):
    ...
    if (len(legLocators)>=9):
        ...
        pm.select(d=True)
        jDef_Rcon=pm.joint(name="jDef_Rcon_"+whichLeg, p=pm.PyNode("Loc_Rcon_"+whichLeg).getTranslation(space="world"), radius=1.5)
        jDef_Upleg=pm.joint(name="jDef_UpLeg_"+whichLeg, p=pm.PyNode("Loc_UpLeg_"+whichLeg).getTranslation(space="world"), radius=1.5)
        ...
        tempPoCon=pm.pointConstraint("Loc_UpLeg_"+whichLeg, startLock, mo=False)
        pm.delete(tempPoCon)
        ...
        initUpperLegDist=extra.getDistance(pm.PyNode("Loc_UpLeg_"+whichLeg), pm.PyNode("Loc_Knee_"+whichLeg))
        initLowerLegDist=extra.getDistance(pm.PyNode("Loc_Knee_"+whichLeg), pm.PyNode("Loc_Foot_"+whichLeg))


        pm.select(d=True)
        jIK_orig_Root=pm.joint(name="jIK_orig_Root_"+whichLeg, p=pm.PyNode("Loc_UpLeg_"+whichLeg).getTranslation(space="world"), radius=1.5)
        ...
        pm.select(d=True)
        jIK_SC_Root=pm.joint(name="jIK_SC_Root_"+whichLeg, p=pm.PyNode("Loc_UpLeg_"+whichLeg).getTranslation(space="world"), radius=1)
        ...
        pm.select(d=True)
        jIK_RP_Root=pm.joint(name="jIK_RP_Root_"+whichLeg, p=pm.PyNode("Loc_UpLeg_"+whichLeg).getTranslation(space="world"), radius=0.7)
        ...
        pm.select(d=True)
        jFK_Root=pm.joint(name="jFK_Root_"+whichLeg, p=pm.PyNode("Loc_UpLeg_"+whichLeg).getTranslation(space="world"), radius=1.0)
        ...
        PvTarget=pm.PyNode("Loc_UpLeg_"+whichLeg).getTranslation(space="world")
        ...
        thighContScale=extra.getDistance(pm.PyNode("Loc_UpLeg_"+whichLeg), pm.PyNode("Loc_Knee_"+whichLeg))/4
        ...
        PvTarget=pm.PyNode("Loc_Rcon_"+whichLeg).getTranslation(space="world")
        ...
        ribbonConnections_upperLeg=cr.createRibbon("Loc_UpLeg_"+whichLeg, "Loc_Knee_"+whichLeg, "up_"+whichLeg, -90)
