...
def createLeg(whichLeg):
    legLocators=pm.ls("Loc*"+whichLeg)
...
###########################
        ...
        masterRoot=pm.spaceLocator(name="masterRoot_"+whichLeg)
        tempPoCon=pm.pointConstraint("Loc_Root_"+whichLeg, masterRoot, mo=False)
        pm.delete(tempPoCon)
        
        masterIK=pm.spaceLocator(name="masterIK_"+whichLeg)
        tempPoCon=pm.pointConstraint("Loc_Foot_"+whichLeg, masterIK)
        pm.delete(tempPoCon)
        
        initUpperLegDist=extra.getDistance(pm.PyNode("Loc_Root_"+whichLeg), pm.PyNode("Loc_Knee_"+whichLeg))
        initLowerLegDist=extra.getDistance(pm.PyNode("Loc_Knee_"+whichLeg), pm.PyNode("Loc_Foot_"+whichLeg))
        
        
        pm.select(d=True)
        #jIK_orig_Root=pm.joint(name="jIK_orig_Root_"+whichLeg, p=pm.getAttr("Loc_Root_"+whichLeg+".translate"), radius=1.5)
        #jIK_orig_Knee=pm.joint(name="jIK_orig_Knee_"+whichLeg, p=pm.getAttr("Loc_Knee_"+whichLeg+".translate"), radius=1.5)
        #jIK_orig_End=pm.joint(name="jIK_orig_End_"+whichLeg, p=pm.getAttr("Loc_Foot_"+whichLeg+".translate"), radius=1.5)        
        jIK_orig_Root=pm.joint(name="jIK_orig_Root_"+whichLeg, p=pm.PyNode("Loc_Root_"+whichLeg).getTranslation(space="world"), radius=1.5)
        jIK_orig_Knee=pm.joint(name="jIK_orig_Knee_"+whichLeg, p=pm.PyNode("Loc_Knee_"+whichLeg).getTranslation(space="world"), radius=1.5)
        jIK_orig_End=pm.joint(name="jIK_orig_End_"+whichLeg, p=pm.PyNode("Loc_Foot_"+whichLeg).getTranslation(space="world"), radius=1.5)        
        pm.select(d=True)
        #jIK_SC_Root=pm.joint(name="jIK_SC_Root_"+whichLeg, p=pm.getAttr("Loc_Root_"+whichLeg+".translate"))
        #jIK_SC_Knee=pm.joint(name="jIK_SC_Knee_"+whichLeg, p=pm.getAttr("Loc_Knee_"+whichLeg+".translate"))
        #jIK_SC_End=pm.joint(name="jIK_SC_End_"+whichLeg, p=pm.getAttr("Loc_Foot_"+whichLeg+".translate"))
        jIK_SC_Root=pm.joint(name="jIK_SC_Root_"+whichLeg, p=pm.PyNode("Loc_Root_"+whichLeg).getTranslation(space="world"), radius=1)
        jIK_SC_Knee=pm.joint(name="jIK_SC_Knee_"+whichLeg, p=pm.PyNode("Loc_Knee_"+whichLeg).getTranslation(space="world"), radius=1)
        jIK_SC_End=pm.joint(name="jIK_SC_End_"+whichLeg, p=pm.PyNode("Loc_Foot_"+whichLeg).getTranslation(space="world"), radius=1)
        pm.select(d=True)
        #jIK_RP_Root=pm.joint(name="jIK_RP_Root_"+whichLeg, p=pm.getAttr("Loc_Root_"+whichLeg+".translate"), radius=0.7)
        #jIK_RP_Knee=pm.joint(name="jIK_RP_Knee_"+whichLeg, p=pm.getAttr("Loc_Knee_"+whichLeg+".translate"), radius=0.7)
        #jIK_RP_End=pm.joint(name="jIK_RP_End_"+whichLeg, p=pm.getAttr("Loc_Foot_"+whichLeg+".translate"), radius=0.7)
        jIK_RP_Root=pm.joint(name="jIK_RP_Root_"+whichLeg, p=pm.PyNode("Loc_Root_"+whichLeg).getTranslation(space="world"), radius=0.7)
        jIK_RP_Knee=pm.joint(name="jIK_RP_Knee_"+whichLeg, p=pm.PyNode("Loc_Knee_"+whichLeg).getTranslation(space="world"), radius=0.7)
        jIK_RP_End=pm.joint(name="jIK_RP_End_"+whichLeg, p=pm.PyNode("Loc_Foot_"+whichLeg).getTranslation(space="world"), radius=0.7)
        pm.select(d=True)
        #jIK_Foot=pm.joint(name="jIK_Foot_"+whichLeg, p=pm.getAttr("Loc_Foot_"+whichLeg+".translate"))
        #jIK_Ball=pm.joint(name="jIK_Ball_"+whichLeg, p=pm.getAttr("Loc_Ball_"+whichLeg+".translate"))
        #jIK_Toe=pm.joint(name="jIK_Toe_"+whichLeg, p=pm.getAttr("Loc_Toe_"+whichLeg+".translate"))
        jIK_Foot=pm.joint(name="jIK_Foot_"+whichLeg, p=pm.PyNode("Loc_Foot_"+whichLeg).getTranslation(space="world"), radius=1.0)
        jIK_Ball=pm.joint(name="jIK_Ball_"+whichLeg, p=pm.PyNode("Loc_Ball_"+whichLeg).getTranslation(space="world"), radius=1.0)
        jIK_Toe=pm.joint(name="jIK_Toe_"+whichLeg, p=pm.PyNode("Loc_Toe_"+whichLeg).getTranslation(space="world"), radius=1.0)
        ...
        target=pm.PyNode("Loc_Foot_"+whichLeg).getTranslation(space="world")
        ...
        pm.makeIdentity(a=True)
        tempCons=pm.pointConstraint( "Loc_Knee_"+whichLeg, cont_Pole, w=.1, mo=False, sk="z")
        pm.delete(tempCons)
        tempCons=pm.pointConstraint( "Loc_ToePv_"+whichLeg, cont_Pole, w=.1, mo=False, sk=["x","y"])
        pm.delete(tempCons)
        tempCons=pm.aimConstraint( "Loc_Knee_"+whichLeg, cont_Pole, w=.1, mo=False, o=(0,0,90))
        pm.delete(tempCons)
        ...
        pm.pointConstraint(masterRoot, legStart, mo=False)
        ...
        extra.alignTo(IK_parentGRP, "Loc_Foot_"+whichLeg)
