...
def createLeg(whichLeg):
     ...
     if (len(legLocators)>=9):
        ...
        pm.setAttr(cont_FK_UpLeg+".sx", lock=True, keyable=False, channelBox=False)
        ...
        pm.setAttr(cont_FK_LowLeg+".sx", lock=True, keyable=False, channelBox=False)
        ...
        pm.setAttr(cont_FK_Foot+".sx", lock=True, keyable=False, channelBox=False)
        ...
        pm.setAttr(cont_FK_Ball+".sx", lock=True, keyable=False, channelBox=False)
