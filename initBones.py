...
def initArmBones(whichArm, dir):
    ...
    pm.select(d=True)
    pinky00=pm.joint(p=(16*dir,25,-1), name=("jInit_pinky00_"+whichArm))
    pinky01=pm.joint(p=(17*dir,25,-1), name=("jInit_pinky01_"+whichArm))
    pinky02=pm.joint(p=(18*dir,25,-1), name=("jInit_pinky02_"+whichArm))
    pinky03=pm.joint(p=(19*dir,25,-1), name=("jInit_pinky03_"+whichArm))

    pm.select(d=True)
    ring00=pm.joint(p=(16*dir,25,-0.5), name=("jInit_ring00_"+whichArm))
    ring01=pm.joint(p=(17*dir,25,-0.5), name=("jInit_ring01_"+whichArm))
    ring02=pm.joint(p=(18*dir,25,-0.5), name=("jInit_ring02_"+whichArm))
    ring03=pm.joint(p=(19*dir,25,-0.5), name=("jInit_ring03_"+whichArm))

    pm.select(d=True)
    middle00=pm.joint(p=(16*dir,25,0), name=("jInit_middle00_"+whichArm))
    middle01=pm.joint(p=(17*dir,25,0), name=("jInit_middle01_"+whichArm))
    middle02=pm.joint(p=(18*dir,25,0), name=("jInit_middle02_"+whichArm))
    middle03=pm.joint(p=(19*dir,25,0), name=("jInit_middle03_"+whichArm))

    pm.select(d=True)
    index00=pm.joint(p=(16*dir,25,0.5), name=("jInit_index00_"+whichArm))
    index01=pm.joint(p=(17*dir,25,0.5), name=("jInit_index01_"+whichArm))
    index02=pm.joint(p=(18*dir,25,0.5), name=("jInit_index02_"+whichArm))
    index03=pm.joint(p=(19*dir,25,0.5), name=("jInit_index03_"+whichArm))

    pm.select(d=True)
    thumb00=pm.joint(p=(15*dir,25,1), name=("jInit_thumb00_"+whichArm))
    thumb01=pm.joint(p=(15*dir,25,1.5), name=("jInit_thumb01_"+whichArm))
    thumb02=pm.joint(p=(15*dir,25,2), name=("jInit_thumb02_"+whichArm))
    thumb03=pm.joint(p=(15*dir,25,2.5), name=("jInit_thumb03_"+whichArm))
