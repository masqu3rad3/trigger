...
class MainUI(QtWidgets.QDialog):
    ...
    def build_ui(self):
        ...
        self.createanchor_pushButton.clicked.connect(lambda: space_switcher.create_space_switch(self.anchorObject, self.anchorLocations, mode=self.anchortype_comboBox.currentText()))
