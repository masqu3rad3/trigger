...
class Icon(object):
    ...
    def fk_ik_switch(name="fkik_cont"):
        ...
        cmds.move(
            ...
            0,
            0,
            "{0}.cv[2]".format(letter_ik_shapes[0]),
            relative=True,
            objectSpace=True,
        ...
        cmds.move(
            ...
            0,
            0,
            "{0}.cv[3]".format(letter_ik_shapes[0]),
            relative=True,
            objectSpace=True,
            worldSpaceDistance=True,
        )
        cmds.move(
            ...
            0,
            0,
            "{0}.cv[6]".format(letter_ik_shapes[0]),
            relative=True,
            objectSpace=True,
            worldSpaceDistance=True,
        )
        cmds.move(
            ...
            0,
            0,
            "{0}.cv[7]".format(letter_ik_shapes[0]),
            relative=True,
            objectSpace=True,
            worldSpaceDistance=True,
        )
        cmds.move(
            ...
            0,
            0,
            "{0}.cv[0:10]".format(letter_ik_shapes[0]),
            relative=True,
            objectSpace=True,
            worldSpaceDistance=True,
        )
        cmds.move(
            ...
            0,
            0,
            "{0}.cv[0:12]".format(letter_ik_shapes[1]),
            relative=True,
            objectSpace=True,
            worldSpaceDistance=True,
        )
        ...
        cmds.addAttr(
            cont_fk_ik,
            shortName="fk_ik_reverse",
            longName="FK_IK_Reverse",
            defaultValue=1.0,
            minValue=0.0,
            maxValue=1.0,
            attributeType="float",
    ...
    def waist(name="waist_cont"):
        ...
        """
        cont_waist = cmds.curve(
            name=name,
            d=1,
            p=[
                (-6.086269, 0, 2.259307),
                (-7.671805, 0, -2.12977e-007),
                (-6.086269, 0, -2.259308),
                (-6.08099, 0, -1.545085),
                (-4.755284, 0, -1.545085),
                (-4.045086, 0, -2.938927),
    ...
    def sphere(name="sphere_cont"):
        cont_sphere = cmds.curve(
            name=name,
            d=1,
            p=[
                (-2.98023e-08, 0, 1),
                (-2.94354e-08, 0.156434, 0.987688),
    ...
    def curved_circle(name="curvedCircle_cont"):
        ...
        Returns:
            Controller node
        """
        cont_curved_circle = cmds.circle(name=name, nr=(0, 1, 0), ch=0, s=12, radius=1)[
            0
        ]
    ...
    def half_dome(name="halfDome_cont"):
        cont_half_curve = cmds.curve(
            ...
            p=[
                ...
                (-0.156435, 0.987688, 0),
                (0, 1, 0),
                (-4.66211e-009, 0.987688, 0.156434),
                (-9.20942e-009, 0.951057, 0.309017),
                (-1.353e-008, 0.891007, 0.453991),
                (-1.75174e-008, 0.809017, 0.587785),
                (-2.10734e-008, 0.707107, 0.707107),
                (-2.41106e-008, 0.587785, 0.809017),
                (-2.65541e-008, 0.453991, 0.891007),
                (-2.83437e-008, 0.309017, 0.951057),
                (-2.94354e-008, 0.156434, 0.987688),
                (-2.98023e-008, 0, 1),
                (0.309017, 0, 0.951057),
                (0.587785, 0, 0.809017),
                (0.809017, 0, 0.587785),
    ...
    def triangle(name="triangle_cont"):
        cont_triangle = cmds.curve(
            name=name,
            d=1,
            p=[(0, 0, -3), (-3, 0, 2), (3, 0, 2), (0, 0, -3)],
            k=[0, 1, 2, 3],
        )
    ...
    def arrow(name="arrow_cont"):
        cont_arrow = cmds.curve(
            name=name,
            d=1,
            p=[
                (0.0335873, 0, 1.055001),
                (-4.955996, 0, 0.971701),
                (-4.983113, 0, 2.081272),
                (-7.934906, 0, -0.0118149),
                (-4.93066, 0, -2.06217),
                (-4.973678, 0, -0.968172),
                (0.0696592, 0, -1.018287),
                (0.0192114, 0, 1.054761),
            ],
            k=[0, 1, 2, 3, 4, 5, 6, 7],
        )
    ...
    def preferences(name="pref_cont"):
        cont_pref = cmds.curve(
            name=name,
            d=1,
            p=[
                (-2.005908, -0.00143437, 2.011916),
                (-2.005908, -0.00143437, -2.997386),
                (0.138344, -0.00143437, -2.997386),
                (0.364393, -0.00143437, -2.990991),
                (0.577802, -0.00143437, -2.971805),
                (0.778569, -0.00143437, -2.939829),
                (0.966696, -0.00143437, -2.895063),
                (1.142182, -0.00143437, -2.837506),
                (1.305028, -0.00143437, -2.767159),
                (1.455232, -0.00143437, -2.684021),
                (1.592796, -0.00143437, -2.588093),
                (1.715837, -0.00143437, -2.479426),
                (1.822472, -0.00143437, -2.358071),
                (1.912702, -0.00143437, -2.224027),
                (1.986526, -0.00143437, -2.077296),
                (2.043945, -0.00143437, -1.917877),
                (2.084959, -0.00143437, -1.745769),
                (2.109567, -0.00143437, -1.560974),
                (2.11777, -0.00143437, -1.363491),
                (2.109539, -0.00143437, -1.165979),
                (2.084849, -0.00143437, -0.981102),
                (2.043697, -0.00143437, -0.808856),
                (1.986085, -0.00143437, -0.649244),
                (1.912013, -0.00143437, -0.502265),
                (1.82148, -0.00143437, -0.367918),
                (1.714486, -0.00143437, -0.246204),
                (1.591032, -0.00143437, -0.137124),
                (1.45311, -0.00143437, -0.0407822),
                (1.302712, -0.00143437, 0.0427137),
                (1.139839, -0.00143437, 0.113364),
                (0.964491, -0.00143437, 0.171169),
                (0.776667, -0.00143437, 0.216129),
                (0.576368, -0.00143437, 0.248242),
                (0.363594, -0.00143437, 0.267511),
                (0.138344, -0.00143437, 0.273934),
                (-0.479363, -0.00143437, 0.273934),
                (-0.479363, -0.00143437, -0.662097),
                (0.000736963, -0.00143437, -0.662097),
                (0.176589, -0.00143437, -0.673313),
                (0.331649, -0.00143437, -0.706958),
                (0.465917, -0.00143437, -0.763035),
                (0.579392, -0.00143437, -0.841541),
                (0.669587, -0.00143437, -0.941439),
                (0.734012, -0.00143437, -1.061687),
                (0.772666, -0.00143437, -1.202287),
                (0.785551, -0.00143437, -1.363238),
                (0.772666, -0.00143437, -1.524095),
                (0.734012, -0.00143437, -1.664412),
                (0.669587, -0.00143437, -1.784188),
                (0.579392, -0.00143437, -1.883424),
                (0.465917, -0.00143437, -1.961269),
                (0.331649, -0.00143437, -2.016872),
                (0.176589, -0.00143437, -2.050235),
                (0.000736963, -0.00143437, -2.061355),
                (-0.714014, -0.00143437, -2.061355),
                (-0.714014, -0.00143437, 2.011916),
                (-2.005908, -0.00143437, 2.011916),
            ],
            k=[
                0,
    ...
    def rotator(name="rotator_cont"):
        _cont = cmds.curve(
            ...
            p=[
                (-1.49012e-08, 0, 1),
                (-1.49012e-08, 0, 1.043301),
                (-1.49012e-08, 0, 1.086603),
                (-1.49012e-08, 0, 1.129904),
                (-2.98023e-08, 0, 1.173205),
                (0.0375, 0, 1.151554),
                (0.075, 0, 1.129904),
                (0.1125, 0, 1.108253),
                (0.15, 0, 1.086603),
                ...
                (0, 0, 0.826795),
                (0, 0, 0.870096),
                (-7.45058e-09, 0, 0.913397),
                (-1.49012e-08, 0, 0.956699),
                (-1.49012e-08, 0, 1),
                (-0.0782174, 0, 0.993844),
                (-0.155953, 0, 0.984649),
                (-0.232726, 0, 0.969373),
                (-0.308066, 0, 0.94813),
                (-0.381504, 0, 0.921032),
                ...
                (-0.969373, 0, 0.232726),
                (-0.984649, 0, 0.155953),
                (-0.993845, 0, 0.0782171),
                (-0.996922, 0, -1.65775e-07),
                (-0.993845, 0, -0.0782174),
                (-0.984649, 0, -0.155953),
                (-0.969373, 0, -0.232726),
                (-0.94813, 0, -0.308066),
                (-0.921032, 0, -0.381504),
                ...
                (-0.232726, 0, -0.969373),
                (-0.155953, 0, -0.984649),
                (-0.0782171, 0, -0.993845),
                (2.23517e-07, 0, -1.000001),
                (2.08616e-07, 0, -0.956699),
                (2.08616e-07, 0, -0.913398),
                (2.08616e-07, 0, -0.870097),
                (1.93715e-07, 0, -0.826796),
                (0.0375002, 0, -0.848446),
                (0.0750002, 0, -0.870097),
                (0.1125, 0, -0.891747),
                (0.15, 0, -0.913398),
                (0.1875, 0, -0.935049),
                (0.225, 0, -0.956699),
                ...
                (0.15, 0, -1.086603),
                (0.1125, 0, -1.108254),
                (0.0750002, 0, -1.129904),
                (0.0375002, 0, -1.151555),
                (2.23517e-07, 0, -1.173206),
                (2.23517e-07, 0, -1.129904),
                (2.16067e-07, 0, -1.086603),
                (2.08616e-07, 0, -1.043302),
                (2.23517e-07, 0, -1.000001),
            ],
            k=[
                0,
    ...
    def curved_arrow(name="curvedArrow_cont"):
        _cont = cmds.curve(
            ...
            p=[
                (0, -0.954929, 1.653986),
                (0.0416667, -0.919075, 1.632761),
                (0.0833333, -0.883692, 1.610758),
                (0.166667, -0.814409, 1.564465),
                (0.333333, -0.682225, 1.463037),
                (0.388889, -0.640193, 1.426713),
                (0.444444, -0.599235, 1.389181),
                (0.5, -0.559385, 1.350474),
                (0.417852, -0.567843, 1.35888),
                (0.335703, -0.576354, 1.367233),
                (0.253555, -0.584916, 1.375532),
                (0.253555, -0.557868, 1.348956),
                (0.253555, -0.531353, 1.321848),
                (0.253555, -0.505381, 1.294219),
                (0.253555, -0.430827, 1.208315),
                (0.253555, -0.361519, 1.118125),
                (0.253555, -0.187432, 0.82511),
                (0.253555, -0.0681992, 0.505817),
                (0.253555, -0.0413541, 0.395286),
                (0.253555, -0.0211365, 0.283353),
                (0.253555, -0.0113765, 0.208148),
                (0.253555, -0.00761816, 0.170415),
                (0.253555, -0.000846997, 0.0568723),
                (0.253555, -0.000846955, -0.0568719),
                (0.253555, -0.00761813, -0.170414),
                (0.253555, -0.0113764, -0.208147),
                (0.253555, -0.0211365, -0.283352),
                (0.253555, -0.041354, -0.395285),
                (0.253555, -0.0681991, -0.505816),
                (0.253555, -0.187432, -0.825109),
                (0.253555, -0.361519, -1.118125),
                (0.253555, -0.430827, -1.208315),
                (0.253555, -0.505381, -1.294219),
                (0.253555, -0.531353, -1.321848),
    ...
    def dual_curved_arrow(name="dualCurvedArrow_cont"):
        _cont = cmds.curve(
            ...
            p=[
                ...
                (-0.253555, -0.041354, -0.395285),
                (-0.253555, -0.0211365, -0.283352),
                (-0.283352, -0.0211365, -0.253555),
                (-0.395285, -0.041354, -0.253555),
                (-0.505816, -0.0681991, -0.253555),
                (-0.825109, -0.187432, -0.253555),
                (-1.118125, -0.361519, -0.253555),
                (-1.208315, -0.430827, -0.253555),
                (-1.294219, -0.505381, -0.253555),
                (-1.321848, -0.531353, -0.253555),
                (-1.348956, -0.557868, -0.253555),
                (-1.375532, -0.584916, -0.253555),
                (-1.367232, -0.576354, -0.335703),
                (-1.35888, -0.567843, -0.417852),
                (-1.350474, -0.559385, -0.5),
                (-1.389181, -0.599235, -0.444444),
                (-1.426713, -0.640193, -0.388889),
                (-1.463037, -0.682225, -0.333333),
                (-1.564465, -0.814409, -0.166667),
                (-1.610758, -0.883692, -0.0833333),
                (-1.632761, -0.919075, -0.0416667),
                (-1.653986, -0.954929, 0),
                (-1.632761, -0.919075, 0.0416667),
                (-1.610758, -0.883692, 0.0833333),
                (-1.564465, -0.814409, 0.166667),
                ...
                (0.253555, -0.0413541, 0.395286),
                (0.253555, -0.0211365, 0.283353),
                (0.283353, -0.0211365, 0.253555),
                (0.395286, -0.0413541, 0.253555),
                (0.505817, -0.0681992, 0.253555),
                (0.82511, -0.187432, 0.253555),
                (1.118125, -0.361519, 0.253555),
                (1.208315, -0.430827, 0.253555),
                (1.294219, -0.505381, 0.253555),
                (1.321848, -0.531353, 0.253555),
    ...
    def cog(name="cog_cont"):
        ...
        _inner_circle = cmds.curve(
            ...
            p=[
                ...
                (0.428693, 0, 0.359716),
                (0.279809, 0, 0.484644),
                (0.0971767, 0, 0.551117),
                (-0.0971768, 0, 0.551117),
                (-0.279809, 0, 0.484644),
                (-0.428693, 0, 0.359716),
                (-0.52587, 0, 0.191401),
                (-0.559619, 0, -1.33424e-07),
                (-0.52587, 0, -0.191401),
                (-0.428693, 0, -0.359716),
                (-0.279809, 0, -0.484644),
                (-0.0971766, 0, -0.551117),
                (0.097177, 0, -0.551117),
                (0.27981, 0, -0.484644),
                (0.428693, 0, -0.359716),
                (0.52587, 0, -0.191401),
