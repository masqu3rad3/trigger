...
class ProximityTransfer(ProtocolCore):
    ...
    type = "topology"
    def __init__(self, source, target, blendshape_pack):
        super(ProximityTransfer, self).__init__(source, target, blendshape_pack)

        self.wrap_node = None

        # define the property values for the protocol
        self["wrapMode"] = Property(attribute_name="wrapMode",
                                    attribute_type="combo",
                                    default_value=1,
                                    items=["offset", "surface", "snap", "rigid", "cluster"])
        self["maxDrivers"] = Property(attribute_name="maxDrivers",
                                    attribute_type="integer",
                                    default_value=1,
                                    minimum=1,
                                    maximum=100)
        self["falloffScale"] = Property(attribute_name="falloffScale",
                                    attribute_type="float",
                                    default_value=1.0,
                                    minimum=0.0,
                                    maximum=9999.0)
        self["smoothInfluences"] = Property(attribute_name="smoothInfluences",
                                    attribute_type="integer",
                                    default_value=7,
                                    minimum=0,
                                    maximum=9999)
        self["smoothNormals"] = Property(attribute_name="smoothNormals",
                                    attribute_type="integer",
                                    default_value=1,
                                    minimum=0,
                                    maximum=9999)
        self["softNormalization"] = Property(attribute_name="softNormalization",
                                    attribute_type="boolean",
                                    default_value=False)
        self["spanSamples"] = Property(attribute_name="spanSamples",
                                    attribute_type="integer",
                                    default_value=2,
                                    minimum=0,
                                    maximum=9999)
