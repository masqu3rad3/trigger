...
class Leg(object):
    ...
    def ikfkSwitching(self):
        ...
        mid_lock_x_bln.outputZ >> self.cont_mid_lock_ave.rotateZ
    ...
    def createDefJoints(self):
        ...
        ribbon_start_ori_con2 = pm.parentConstraint(self.j_def_hip, ribbon_upper_leg.startAim, mo=False, skipTranslate=["x","y","z"] )
    ...
    def createAngleExtractors(self):
        ...
        self.cont_fk_up_leg.rotateZ >> angleRemapFK.inputValue
