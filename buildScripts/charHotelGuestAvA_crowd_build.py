...
# baserig_file = "/mnt/ps-storage01/vfx_hgd_000/SG_ROOT/eg2/assets/Character/charHotelGuest/RIG/work/maya/rootCharHotelGuestAvA.v005.ma"
baserig_file = "/mnt/ps-storage01/vfx_hgd_000/SG_ROOT/eg2/assets/Character/charHotelGuest/RIG/work/maya/rootCharHotelGuestAvA.v003.ma"
cmds.file(baserig_file, open=True, force=True)
meshes_file = "/mnt/ps-storage01/vfx_hgd_000/SG_ROOT/eg2/assets/Character/charHotelGuest/MDL/publish/maya/charHotelGuestAvA.v006.ma"
fileHandler.import_scene(meshes_file)

variation_meshes = functions.getMeshes("charHotelGuestAvA")
...
rig_grp = cmds.group(["rootCharHotelGuestAvA", "charHotelGuestAvA"], name="rig_grp")
...
# grp renaming
cmds.rename("charHotelGuestAvA", "renderGeo_grp")

# extra bullet-proofing
functions.lockAndHide("renderGeo_grp")
functions.lockAndHide("rootCharHotelGuestAvA")
