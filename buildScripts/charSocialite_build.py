...
cmds.file("/mnt/ps-storage01/vfx_hgd_000/SG_ROOT/eg2/assets/Character/charSocialite/RIG/work/maya/rootCharSocialiteAvA.v005.ma",open=True, force=True)
...
face_meshes = ["charSocialiteAvA_teethUpper_IDplastic_1",
               "charSocialiteAvA_teethLower_IDplastic_1",
               "charSocialiteAvA_tongue_IDskin_1",
               "charSocialiteAvA_hair_IDwood_1",
               "charSocialiteAvA_face_IDmulti_1",
               "charSocialiteAvA_outerEyeR_IDglass_1",
               "charSocialiteAvA_outerEyeL_IDglass_1",
               "charSocialiteAvA_innerEyeL_IDskin_1",
               "charSocialiteAvA_innerEyeR_IDskin_1",
               ]
...
TWK_MESH = "charSocialiteAvA_face_IDmulti_1_local"
...
sessionHandler.load_session(
    "/mnt/ps-storage01/vfx_hgd_000/SG_ROOT/eg2/assets/Character/charSocialite/RIG/work/maya/triggerData/guides/socialite_local_bs_guides.json",
    reset_scene=False)
...
# # move the orientation of the joint to the upper level
# upper_jnt_orient = cmds.getAttr("upperTeeth_jDef.jointOrient")[0]
# cmds.setAttr("%s.r" % upperTeeth_jDef_drive, *upper_jnt_orient)
# cmds.setAttr("upperTeeth_jDef.jointOrient", 0, 0, 0)
# lower_jnt_orient = cmds.getAttr("lowerTeeth_jDef.jointOrient")[0]
# cmds.setAttr("%s.r" % lowerTeeth_jDef_drive, *lower_jnt_orient)
# cmds.setAttr("lowerTeeth_jDef.jointOrient", 0, 0, 0)
...
sessionHandler.load_session(
    "/mnt/ps-storage01/vfx_hgd_000/SG_ROOT/eg2/assets/Character/charSocialite/RIG/work/maya/triggerData/guides/socialite_twk_guides.json",
    reset_scene=False)
...
main_face_mesh = "charSocialiteAvA_face_IDmulti_1"
...
weights_root = "/mnt/ps-storage01/vfx_hgd_000/SG_ROOT/eg2/assets/Character/charSocialite/RIG/work/maya/triggerData/weights/"
...
a = cmds.duplicate("charSocialiteAvA_face_IDmulti_1")
b = cmds.duplicate("charSocialiteAvA_hair_IDwood_1")
...
other_meshes = ["charSocialiteAvA_teethUpper_IDplastic_1",
                "charSocialiteAvA_teethLower_IDplastic_1",
                "charSocialiteAvA_tongue_IDskin_1",
                "charSocialiteAvA_hair_IDwood_1",
                "charSocialiteAvA_face_IDmulti_1",
...
# load the guides
session_path = "/mnt/ps-storage01/vfx_hgd_000/SG_ROOT/eg2/assets/Character/charSocialite/RIG/work/maya/triggerData/guides/socialite_stretchyFace.json"
...
lattice_deformer, lattice_points, lattice_base = cmds.lattice(
    ...
    ol=True,
    objectCentered=True,
    name="%s_ffd" % "socialite_head_stretch",
)
...
shapesHandler.import_shapes("/mnt/ps-storage01/vfx_hgd_000/SG_ROOT/eg2/assets/Character/charSocialite/RIG/work/maya/triggerData/shapes/socialite_control_shapes.abc")
...
functions.lockAndHide("charSocialiteAvA_grp")
cmds.parent("charSocialiteAvA_grp", renderGeo_grp)
...
functions.deleteObject("Char_Socilaite_clothing")
functions.deleteObject("MA_Hands_Generic")
functions.deleteObject("Male_head")
functions.deleteObject("MA_Hair_Socialite")
...
for side in "LR":
    ...
    spec_geo = "charSocialiteAvA_spec%s_IDglass_1" % side
    ...
    lattice_set = cmds.listConnections("socialite_head_stretch_ffd", s=False, d=True, type="objectSet")[0]
