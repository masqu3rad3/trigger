...
cmds.file("/mnt/ps-storage01/vfx_hgd_000/SG_ROOT/eg2/assets/Character/charZalika/RIG/work/maya/rootCharZalika.v011.ma",open=True, force=True)
...
final_meshes = functions.getMeshes("charZalikaAvA")

# build the BASEs of Local Rigs
face_meshes = ["charZalikaAvA_tongue_idTongue_GEO",
               "charZalikaAvA_teethUpper_idTeeth_GEO",
               "charZalikaAvA_teethLower_idTeeth_GEO",
               # "charZalikaAvA_eyeLashLower_idEyeLashes_GEO",
               # "charZalikaAvA_eyeLashUpper_idEyeLashes_GEO",
               # "charZalikaAvA_eyeBrows_idHair_GEO",
               "charZalikaAvA_head_idSkin_GEO",
               "charZalikaAvA_EyeInnerR_idEyeInner_GEO",
               "charZalikaAvA_EyeouterR_idEyeOutter_GEO",
               "charZalikaAvA_EyeouterL_idEyeOuter_GEO",
               "charZalikaAvA_EyeInnerL_idEyeInner_GEO",
               "charZalikaAvA_caruncle_idCaruncle_GEO",
               "charZalikaAvA_specLense_idSpecLens_GEO",
               "charZalikaAvA_specs_idWhitePVC2_GEO",
               "charZalikaAvA_helmetglass_idHelmetGlass_GEO",
               "charZalikaAvA_micshaft_idMetal_GEO",
               "charZalikaAvA_mic_idRubber_GEO",
               "charZalikaAvA_hairfront1_idHair_GEO",
               "charZalikaAvA_hairfront2_idHair_GEO",
               "charZalikaAvA_hairfront3_idHair_GEO",
               "charZalikaAvA_hairsides_idHair_GEO",
               "charZalikaAvA_hireshair_idHair_GEO",
               "charZalikaAvA_top_idWhitePVC_GEO"
               ]
local_meshes = []
...
TWK_MESH = "charZalikaAvA_head_idSkin_GEO_local"
...
sessionHandler.load_session(
    "/mnt/ps-storage01/vfx_hgd_000/SG_ROOT/eg2/assets/Character/charZalika/RIG/work/maya/triggerData/guides/zalika_local_bs_guides.json",
    reset_scene=False)
...
sessionHandler.load_session(
    "/mnt/ps-storage01/vfx_hgd_000/SG_ROOT/eg2/assets/Character/charZalika/RIG/work/maya/triggerData/guides/zalika_twk_guides.json",
    reset_scene=False)
...
main_face_mesh = "charZalikaAvA_head_idSkin_GEO"
...
# stretchy_mesh = "charZalikaAvA_head_idSkin_GEO_local"

# dup_1 = cmds.duplicate("charZalikaAvA_head_idSkin_GEO")
# dup_2 = cmds.duplicate("charZalikaAvA_hireshair_idHair_GEO")
# stretchy_mesh = cmds.polyUnite(dup_1, dup_2, ch=False)[0]
stretchy_mesh = "charZalikaAvA_helmetglass_idHelmetGlass_GEO_local"

# Define other objects that will stretch ALL MESHES NEEEDS TO BE BLENDSHAPED to final Mesh
other_meshes = ["charZalikaAvA_tongue_idTongue_GEO_local",
                "charZalikaAvA_teethUpper_idTeeth_GEO_local",
                "charZalikaAvA_teethLower_idTeeth_GEO_local",
                # "charZalikaAvA_eyeLashLower_idEyeLashes_GEO_local",
                # "charZalikaAvA_eyeLashUpper_idEyeLashes_GEO_local",
                # "charZalikaAvA_eyeBrows_idHair_GEO_local",
                "charZalikaAvA_head_idSkin_GEO_local",
                "charZalikaAvA_EyeInnerR_idEyeInner_GEO_local",
                "charZalikaAvA_EyeouterR_idEyeOutter_GEO_local",
                "charZalikaAvA_EyeouterL_idEyeOuter_GEO_local",
                "charZalikaAvA_EyeInnerL_idEyeInner_GEO_local",
                # "charZalikaAvA_helmetglass_idHelmetGlass_GEO_local",
                "charZalikaAvA_caruncle_idCaruncle_GEO_local",
                "charZalikaAvA_specLense_idSpecLens_GEO_local",
                "charZalikaAvA_hairfront1_idHair_GEO_local",
                "charZalikaAvA_hairfront2_idHair_GEO_local",
                "charZalikaAvA_hairfront3_idHair_GEO_local",
                "charZalikaAvA_hairsides_idHair_GEO_local",
                "charZalikaAvA_hireshair_idHair_GEO_local",
                "charZalikaAvA_micshaft_idMetal_GEO_local",
                "charZalikaAvA_mic_idRubber_GEO_local",
                "charZalikaAvA_specs_idWhitePVC2_GEO_local",
                "charZalikaAvA_top_idWhitePVC_GEO_local",
                ]
...
# load the guides
session_path = "/mnt/ps-storage01/vfx_hgd_000/SG_ROOT/eg2/assets/Character/charZalika/RIG/work/maya/triggerData/guides/zalika_stretchyFace.json"
...
# Load Weightsw
# weights_path = "/mnt/ps-storage01/vfx_hgd_000/SG_ROOT/eg2/assets/Character/charZalika/RIG/work/maya/triggerData/weights/charZalikaAvA_helmetglass_idHelmetGlass_GEO_local_ffd.json"
...
# ffd_name = "charZalikaAvA_helmetglass_idHelmetGlass_GEO_local_ffd"
# weightHandler.save_weights(deformer=lattice_deformer, file_path=weights_path, vertexConnections=False, force=True, influencer=None)
