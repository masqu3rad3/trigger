...
def createArm(whichArm):
    ...
    if fingerCount > 0:
        pm.addAttr(cont_FK_IK, longName="Index_Finger", at="enum", en="--------", k=True)
        pm.addAttr(cont_FK_IK, shortName="indexBendA", longName="Index_Bend_A", defaultValue=0.0, at="float", k=True)
        pm.addAttr(cont_FK_IK, shortName="indexBendB", longName="Index_Bend_B", defaultValue=0.0, at="float", k=True)
        pm.addAttr(cont_FK_IK, shortName="indexBendC", longName="Index_Bend_C", defaultValue=0.0, at="float", k=True)
        pm.addAttr(cont_FK_IK, shortName="indexSpread", longName="Index_Spread", defaultValue=0.0, at="float", k=True)

        if fingerCount > 1:
            pm.addAttr(cont_FK_IK, longName="Thumb", at="enum", en="--------", k=True)
            pm.addAttr(cont_FK_IK, shortName="thumbUpDown", longName="Thumb_Up_Down", defaultValue=0.0, at="float", k=True)
            pm.addAttr(cont_FK_IK, shortName="thumbBendA", longName="Thumb_Bend_A", defaultValue=0.0, at="float", k=True)
            pm.addAttr(cont_FK_IK, shortName="thumbBendB", longName="Thumb_Bend_B", defaultValue=0.0, at="float", k=True)
            pm.addAttr(cont_FK_IK, shortName="thumbSpread", longName="Spread_Thumb", defaultValue=0.0, at="float", k=True)

            if fingerCount > 2:
                pm.addAttr(cont_FK_IK, longName="Middle_Finger", at="enum", en="--------", k=True)
                pm.addAttr(cont_FK_IK, shortName="middleBendA", longName="Middle_Bend_A", defaultValue=0.0, at="float", k=True)
                pm.addAttr(cont_FK_IK, shortName="middleBendB", longName="Middle_Bend_B", defaultValue=0.0, at="float", k=True)
                pm.addAttr(cont_FK_IK, shortName="middleBendC", longName="Middle_Bend_C", defaultValue=0.0, at="float", k=True)
                pm.addAttr(cont_FK_IK, shortName="middleSpread", longName="Middle_Spread", defaultValue=0.0, at="float", k=True)

                if fingerCount > 3:
                    pm.addAttr(cont_FK_IK, longName="Ring_Finger", at="enum", en="--------", k=True)
                    pm.addAttr(cont_FK_IK, shortName="ringBendA", longName="Ring_Bend_A", defaultValue=0.0, at="float", k=True)
                    pm.addAttr(cont_FK_IK, shortName="ringBendB", longName="Ring_Bend_B", defaultValue=0.0, at="float", k=True)
                    pm.addAttr(cont_FK_IK, shortName="ringBendC", longName="Ring_Bend_C", defaultValue=0.0, at="float", k=True)
                    pm.addAttr(cont_FK_IK, shortName="ringSpread", longName="Ring_Spread", defaultValue=0.0, at="float", k=True)

                    if fingerCount > 4:
                        pm.addAttr(cont_FK_IK, longName="Pinky_Finger", at="enum", en="--------", k=True)
                        pm.addAttr(cont_FK_IK, shortName="pinkyBendA", longName="Pinky_Bend_A", defaultValue=0.0, at="float", k=True)
                        pm.addAttr(cont_FK_IK, shortName="pinkyBendB", longName="Pinky_Bend_B", defaultValue=0.0, at="float", k=True)
                        pm.addAttr(cont_FK_IK, shortName="pinkyBendC", longName="Pinky_Bend_C", defaultValue=0.0, at="float", k=True)
                        pm.addAttr(cont_FK_IK, shortName="pinkySpread", longName="Pinky_Spread", defaultValue=0.0, at="float", k=True)
    ...
    handContScale=extra.getDistance(pm.PyNode("jInit_Low_{}".format(whichArm)), pm.PyNode("jInit_LowEnd_{}".format(whichArm)))/4
...
# //TODO WORKING ON THE PROCEDURALISM -- THIS IS THE SOURCE
    ...
    cont_FK_IK.thumbSpread >> cont_thumb00_con.rotateY
